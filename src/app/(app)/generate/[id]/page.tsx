...
import { GenContent } from '@/components/gen-content'
import { useState, useEffect} from 'react'
import { apiClient } from '@/lib/http/apiClient'


export default function Event({ params }: { params: { id: string } }) {
  const [contentGenerated, setContentGenerated] = useState(null);
  ...
  useEffect(() => {
    async function fetchData() {
        ...
        try {
          ...
          setContentGenerated(responseContentAnalytics.contentAnalytic.postSugestion)
  ...
  return (
    <>
      ...
      <GenContent data={contentGenerated}/>
